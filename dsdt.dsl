 ...
 *
 * Disassembly of dsdt.dat, Wed Feb  1 10:16:46 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00019CF0 (105712)
 *     Revision         0x02
 *     Checksum         0x53
 *     OEM ID           "INTEL"
 *     OEM Table ID     "TGL     "
...
DefinitionBlock ("", "DSDT", 2, "INTEL", "TGL     ", 0x00000000)
{
    ...
    Scope (\)
    {
        ...
        Name (SS3, Zero)
        Name (SS4, One)
        OperationRegion (GNVS, SystemMemory, 0x7DB94000, 0x0ABC)
    ...
    Method (SCFQ, 0, NotSerialized)
    {
        OperationRegion (SYIO, SystemIO, 0x040D, 0x10)
